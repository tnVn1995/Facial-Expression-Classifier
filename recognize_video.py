...
ap.add_argument("-pre", "--pretrained", required=True,
    help="path to the trained emotion classifier")
...
while True:
    ...
    for i in range(0, detections.shape[2]):
        ...
        if confidence > args["confidence"]:
            ...
            # face = tf.data.Dataset.from_tensor_slices(face)
